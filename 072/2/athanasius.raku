...
sub MAIN
(
    Str:D     :$file = 'input.txt',                   #= The name of a readable text file
    Natural:D :$A = 3,                      #= Lower bound of range of lines
    Natural:D :$B where { $A <= $B } = 6,   #= Upper bound of range of lines: A <= B
)
#===============================================================================
{
