...
#multi sub MAIN( @example ) { say "Input:  " ~ @example.raku; say 'Output: ' ~ challenge(@example).raku; }

#multi sub MAIN( 'challenge' ) { my @examples = ("opt", "bat", "saw", "tab", "pot", "top", "was").Array, ("x").Array; @examples.map: { MAIN($_) }; }
