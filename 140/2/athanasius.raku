...
sub MAIN
(
    Positive:D $i = 1000,     #= Positive integer: maximum multiplier   for the  table
    Positive:D $j =  999,     #= Positive integer: maximum multiplicand for the  table
    Positive:D $k = 314159 #where * <= $i * $j
