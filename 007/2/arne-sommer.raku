...
# very slow
#multi sub MAIN ($first = 'fast', $second = 'slow', $dictionary where $dictionary.IO && $dictionary.IO.r = 'words', :$all)
#("fast","cast","cost","coot","soot","slot","slow")

multi sub MAIN ($first = 'bat', $second = 'big', $dictionary where $dictionary.IO && $dictionary.IO.r = 'words3', :$all)
{
