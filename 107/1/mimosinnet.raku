...
#multi sub MAIN( Int $elems ) { say "Write a script to display the first $elems self-descriptive numbers: "; say 'Output: ',challenge1($elems).Str; }

#multi sub MAIN( 'challenge' ) { MAIN(3); }
