...
#multi sub MAIN(Roman $n='V',  Roman $m='VI') { say d2r( $n.&r2d + $m.&r2d ) }
#multi sub MAIN(Roman $n='LI', Roman $m='IV') { say d2r( $n.&r2d - $m.&r2d ) }
multi sub MAIN(Roman $n='V',  Roman $m='VI') { say d2r( $n.&r2d × $m.&r2d ) }
#multi sub MAIN(Roman $n=='X', Roman $m='II') { say d2r( ($n.&r2d ÷ $m.&r2d).Int ) }
